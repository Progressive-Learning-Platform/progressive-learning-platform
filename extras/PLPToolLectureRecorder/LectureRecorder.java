...
public class LectureRecorder extends JFrame implements PLPGenericModule {
    ...
    private JButton ctrlRec;
    private JButton ctrlStop;
    private JButton ctrlReplay;
    ...
    private void initComponents() {
        ...
        ctrlRec = new JButton();
        ctrlRec.setText("Record");
        c.gridx = 0;
        c.gridy = 1;
        ctrlRec.addActionListener(new java.awt.event.ActionListener() {
           public void actionPerformed(java.awt.event.ActionEvent evt) {
               hook("record");
           }
        });
        ...
        ctrlStop = new JButton();
        ctrlStop.setText("Stop");
        c.gridx = 1;
        c.gridy = 1;
        ctrlStop.addActionListener(new java.awt.event.ActionListener() {
           public void actionPerformed(java.awt.event.ActionEvent evt) {
               hook("stop");
           }
        });
        ...
        ctrlReplay = new JButton();
        ctrlReplay.setText("Replay");
        c.gridx = 2;
        c.gridy = 1;
        ctrlReplay.addActionListener(new java.awt.event.ActionListener() {
           public void actionPerformed(java.awt.event.ActionEvent evt) {
               hook("replay");
           }
        });
        pane.add(ctrlReplay, c);
    }
