...
public class ISASelector extends javax.swing.JDialog {
    private List<ArchitectureInformation> archs;
    ...
    public final void populateISASelector() {
        ...
        for(ArchitectureInformation arch : archs) {
            cmbISA.addItem(arch.getIdentifier() + " - ID:" + arch.getId() + " (" + arch.getType().getCanonicalName() + ")");
        }
    }
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        if(plp.isSimulating())
            plp.desimulate();
        int archID = archs.get(cmbISA.getSelectedIndex()).getId();
        plp.setArch(archID);
        plp.assemble();
        this.setVisible(false);
    ...
    private void cmbISAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbISAActionPerformed
        if(cmbISA.getSelectedIndex() != -1) {
            String description = archs.get(cmbISA.getSelectedIndex()).getDescription();
